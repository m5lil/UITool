...
var _scrollreveal = require('./modules/scrollreveal');
...
(0, _jquery2.default)(window).on('load', function () {
	window.sr = (0, _scrollreveal2.default)().reveal('.header');
});
//

},{"./modules/scrollreveal":2,"jquery":3}],2:[function(require,module,exports){
'use strict';
